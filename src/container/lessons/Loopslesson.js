...
<div className="mainContainer" style={{paddingLeft:70, paddingRight:70, paddingBottom:100}}>
                <h1 style={{fontSize:50, paddingTop:8}}>Lesson 4</h1>
...
<div><Image src={require("../../assets/loop.jpg")} size="large" style={{marginLeft:370}}/></div>
                ...
                <div className="loopControl">
                    <div style={{fontWeight:'bold',fontSize:20}}><p>Loop Control Statements</p></div>
                    <div style={{fontSize:16,marginTop:10}}>Loop control statements change execution from its normal sequence. When execution leaves a scope, all automatic objects that were created in that scope are destroyed.</div>
                    <div style={{fontSize:16,marginTop:10}}>Java supports the following control statements.</div>
                    <div>
                        <Table celled>
                        <Table.Header>
                        <Table.Row>
