    ...
    submitCode = () => {
        ...
        fetch('https://cors-anywhere.herokuapp.com/https://api.jdoodle.com/execute', {
            ...
            if (response.memory === null) {
                ...
                console.log(response.output);
                isCorrect = (String(response.output) === String(testCode[this.props.match.params.number].expectedResult))
            }
            this.setState({
                        ...
                        <div className="rightMostContainer" style={{ marginLeft: 30, marginTop: 30 }}>
                            <div>
                                <Comment.Group size="large">
                                    ...
                                    {
                                        comments[this.props.match.params.number].map((commentObject, index) => <CommentBlock  {...commentObject} />)
                                        //<CommentBlock />
                                    }
                                </Comment.Group>
                            </div>
