...
export default class Challenge extends Component {
      ...
      .then(response => {
        ...
        if (response.memory === null) {
          ...
          isCorrect =
            ...
            String(testCode[this.props.match.params.number].expectedResult);
        }
        this.setState({
  ...
  addReply = () => {
    ...
    this.setState(
      prevS => {
        // push the new objecy into corresponding array
  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          <div style={{ textAlign: "center", fontSize: 20, paddingTop: 40 }} />
                    ...
                    <div style={{}}>
                      {this.state.output !== "" ? (
                        !this.state.correct ? (
                          ...
                          >
                            Opps! Seems like something wrong with your code!
                          </div>
                        ) : (
                          <div
                            style={{
