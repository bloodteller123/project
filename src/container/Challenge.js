...
import { Card, Button, Comment, Header, Form, Image } from "semantic-ui-react";
...
export default class Challenge extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      tCode: testCode[props.match.params.number].code,
      description: testCode[props.match.params.number].description,
      challengeNumber: props.match.params.number + 1,
      title: testCode[props.match.params.number].challengeTitel,
      hint: testCode[props.match.params.number].hint,
  ...
  createArray = () => {
    // 2d array ? array of comments for each lesson
    let temp = [];
      ...
      .then(response => {
        ...
        if (response.memory === null) {
          ...
          isCorrect =
            ...
            String(testCode[this.props.number].expectedResult);
        }
        this.setState({
  ...
  render() {
    ...
    const CommentBlock = commentObject => {
      return (
        <Comment>
          {!(
            Object.entries(commentObject).length === 0 &&
            commentObject.constructor === Object
          ) ? (
            <Comment>
                ...
                <Comment.Group size="large">
                  ...
                  <Comment>
                    ...
                    <Comment.Content>
                      ...
                      <Comment.Text>
                        <p>
                          This has been very useful for my programming study.
                          Thanks as well!
                        </p>
                      </Comment.Text>
                      <Comment.Actions>
